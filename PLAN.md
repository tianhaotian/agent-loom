...
7. 继续实现 PostgreSQL/MySQL `0005_wait_artifact`，接入 migration runner 与真实数据库 smoke test；随后实现 PostgreSQL `create_run/claim_task/complete_task` 事务路径和 Mock Agent Server，跑通最小垂直链路。
